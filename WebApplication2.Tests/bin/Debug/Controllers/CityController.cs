...
namespace WebApplication2.Controllers
{
    public class CityController : ApiController
    {
        ...
        //private readonly Uri countryBaseAddress = new Uri(ConfigurationManager.AppSettings["countryBaseAddress"]);
        //private readonly Uri weatherBaseAddress = new Uri(ConfigurationManager.AppSettings["weatherBaseAddress"]);
        ...
        public CityController()
        {
            ...
            client1.BaseAddress = new Uri(ConfigurationManager.AppSettings["countryBaseAddress"]);//countryBaseAddress;
